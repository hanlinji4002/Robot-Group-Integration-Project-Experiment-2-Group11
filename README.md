...
│           └── sim_dc4008.launch.py    一键启动 DC4008 流程
│
...
流程 1/2/3 分别维护独立控制节点；DC4008 流程通过节点重命名复用流程 1
...
`sim_dc4008.launch.py` 切换流程。表中 J1 幅度为 A/B 平面方位角差的近似值。

## 代码模块化说明

仿真代码按职责拆成四个模块。四套场景数据与日志相互独立；DC4008 流程共享流程 1
