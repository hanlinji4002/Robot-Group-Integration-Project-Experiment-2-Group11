"""一键启动仿真系统 —— 抓取流程 Qi_Chu（独立于 sim2.launch.py，互不影响）。
...
def generate_launch_description():
    ...
    grasp = Node(
        package='mecharm_grasp', executable='grasp_task_Qi_Chu',
