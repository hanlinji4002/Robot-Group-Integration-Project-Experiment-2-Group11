...
程序里装了三套抓取动作，方块位置不同，分别维护独立文件。

| | 流程 1 | 流程 2 | 流程 3 |
|---|---|---|---|
| 取物点 A | [0.12, 0.08] | [0.137, 0.029] | [0.095, 0.095] |
| 放置点 B | [0.12, -0.08] | [0.052, -0.130] | [0.100, -0.090] |
| 工作半径 | 0.144 m | 0.140 m | A 0.134 m / B 0.135 m |
| J1 转动幅度 | 67° | 80° | 约 87° |
| A 点偏离正前方 | 34° | 12° | 45° |
...
三套都实测 5 次抓取全部成功。表中 J1 幅度为 A/B 平面方位角差的近似值。
